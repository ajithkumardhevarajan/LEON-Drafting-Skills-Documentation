"""
CDK stack for deploying spot-story MCP server to ECS behind ALB.
Based on the urgent-drafting-mcp infrastructure pattern.
"""
...
class MCPStack(Stack):
    """
    CDK Stack for deploying spot-story MCP server to ECS with ALB.
