"""
Configuration for text-archive MCP deployment to AWS ECS.
"""
...
@dataclass
class MCPConfig:
    """Configuration for text-archive MCP deployment"""

    # Environment (required parameter)
    environment: str = "dev"  # Environment name (dev, qa, staging, prod)

    # Basic identifiers
    mcp_name: str = "text-archive-skill"
    service_name: str = "text-archive"  # Short name for TR CDK naming
    service_full_name_display: str = "text-archive"  # Full name for display/logs
    ...
    # AWS Secrets Manager (dynamically set)
    ...
    def get_environment_variables(self) -> Dict[str, str]:
        ...
        Reads non-secret variables from .env file in the parent directory.
        """
        env_vars = {
