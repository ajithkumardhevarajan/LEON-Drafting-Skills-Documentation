...
# Convenience script to run the Urgent Drafting MCP Server in Docker locally
...
#
# Usage:
#   ./run-docker-local.sh           # Run on default port 8003
...
IMAGE_NAME="urgent-drafting-local"
CONTAINER_NAME="urgent-drafting-dev"
DOCKERFILE="Dockerfile.local"
PORT="${1:-8003}"
SECRET_NAME="a207920-leon-skills"
AWS_REGION="eu-west-1"

echo -e "${BLUE}=== Urgent Drafting MCP Server - Docker Local Runner ===${NC}"
echo ""
...
echo -e "  REUTERS_API_KEY: ${REUTERS_API_KEY:+SET (${#REUTERS_API_KEY} chars)}${REUTERS_API_KEY:-NOT SET}"
...
# Build from parent directory to include both shared/ and urgent-drafting/
docker build \
